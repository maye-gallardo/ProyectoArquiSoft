...
describe("GeneradorDeBoletas", function() {
    it("deberia mostrar una boleta con un salario 0", function() {
      ...
      it("si se genera una boleta para Juan Perez de tipo comision debe resivir el salario de es tipo de jornada", function() {
        let empleado = new Empleado("Pepito Gonzalez");
      ...
      it("si se genera una boleta para Juan Perez de tipo comision debe resivir el salario de es tipo de jornada", function() {
        let empleado = new Empleado("Pepito Gonzalez");
        let boletaPago = new GeneradorDeBoletas(empleado, new TiempoParcial(500, 2));
        expect(boletaPago.monto).equal(1000);
      });
